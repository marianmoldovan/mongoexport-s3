...
aws s3 cp texttopay.json s3://${S3_BUCKET}/texttopay.json
...
aws s3 cp telemedicine.json s3://${S3_BUCKET}/telemedicine.json
...
aws s3 cp missedcallai.json s3://${S3_BUCKET}/missedcallai.json
...
aws s3 cp aiautodialer.json s3://${S3_BUCKET}/aiautodialer.json
